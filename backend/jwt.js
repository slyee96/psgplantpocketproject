...
var i 	= 'Laiyee';    	// Issuer (Software organization who issues the token)
var s 	= 'admin@plantpocket';	// Subject (intended user of the token)
var a 	= 'plantpocketproject.vercel.app';	// Audience (Domain within which this token will live and function)
